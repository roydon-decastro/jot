    ...
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <form method="POST" action="{{ route('login') }}" class="pt-8">
                        ...
                        <div class="relative">
                            ...
                            <div class="">
                                <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" placeholder="your@email.com" name="email" value="{{ old('email') }}"  autocomplete="email" autofocus>
                        ...
                        <div class="relative pt-3">
                            ...
                            <div class="">
                                <input id="password" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" placeholder="Password" name="password" value="{{ old('email') }}"  autofocus>
